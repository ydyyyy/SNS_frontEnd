...
import { getActivitiesFinished } from '@/api/activity'

export default {
    name: "ActivityFinishedScrollPage",
    props: {
        offset: {
            type: Number,
            default: 100
    ...
    methods: {
        ...
        getActivitiesFinished() {
            ...
            getActivitiesFinished(that.query, that.innerPage).then(data => {
