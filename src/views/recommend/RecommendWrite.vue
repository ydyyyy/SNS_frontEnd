  ...
  export default {
    ...
    mounted() {
      ...
      if (this.$route.params.id) {
        this.getRecommendById(this.$route.params.id);
      }
    ...
    methods: {
      getRecommendById(id) {
        ...
        getRecommendById(id)
          .then((data) => {
            console.log(data, "我是getRecommendById获取到的数据");
      ...
      publish(articleForm) {
        ...
        this.$refs[articleForm].validate((valid) => {
          if (valid) {
            ...
            publishRecommend(article)
              .then((data) => {
                console.log(data, "我是publishRecommend返回的数据");
                loading.close();
                that.$message({
                  message: "发布成功啦",
                  type: "success",
      ...
      getCategorysAndTags() {
        ...
        getAllIndustryDetail()
          .then((data) => {
            console.log(data, "我是getAllIndustryDetail获取到的数据");
