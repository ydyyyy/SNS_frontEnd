...
import { getAllCategorysDetail } from "@/api/activityCategory";
import { getAllTagsDetail } from "@/api/activityTag";

export default {
    name: "ActivityAllCategoryTag",
    created() {
        this.getCategorys();
        this.getTags();
    },
