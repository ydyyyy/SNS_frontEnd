...
// 公司分类请求
Mock.mock('http://localhost:8888/stack/hot', recommend.getHotstack)
Mock.mock('http://localhost:8888/stack/detail', recommend.getAllstackDetail)
Mock.mock(/http:\/\/localhost:8888\/stack\/detail\/\w+/, 'get', recommend.getstackDetail);
